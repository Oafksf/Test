...
class Evtx2Splunk(object):
    ...
    def configure(self, index:str, nb_ingestors: int, testing: bool, no_resolve: bool):
        ...
        """
        self._splunk_url = os.getenv("SPLUNK_URL", "https://192.168.1.145")
        self._splunk_port = os.getenv("SPLUNK_PORT", 443)

        splunk_ssl_verify = True
        username = "your_username"
        password = "your_password"

        self._splunk_helper = SplunkHelper(self._splunk_url, self._splunk_port, splunk_ssl_verify, username, password)
        load_dotenv()
